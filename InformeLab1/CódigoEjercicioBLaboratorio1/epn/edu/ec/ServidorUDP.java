...
public class ServidorUDP {
	...
	public static void main(String[] args) throws IOException {
		...
		System.err.println(" Servidor escuchando en el puerto  " + PUERTO
				+ " usando una conexión UDP\n");
		...
		try {
			while (true) {
				...
				System.out.println("Puerto del cliente: " + clientePuerto
						+ "\n");
				// Paquete enviado
				String msg = "Mensaje desde la  pc de Escritorio de Daniel";
				byte bufferSend[] = msg.getBytes();
				DatagramPacket sendPacket = new DatagramPacket(bufferSend,
						bufferSend.length, clientAddress, clientePuerto);
